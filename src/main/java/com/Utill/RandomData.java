...
public class RandomData extends BaseClass{

	public static String indZip="122018";
	public static String usZip="20037";
	public static String chinaZip="518000";
	public static  String State = null;
	public static String Unit = null;
	public static String SpaceType = null;
	public static String OwnerType  = null;
	public static String ZipCode = null;
	
	public static void selectIndState(String country) {
		...
		data.setCellData(sheetName, "Country", rowNumTwo, country);
		data.setCellData(sheetName, "State", rowNumTwo, State);		
		data.setCellData(sheetName, "ZipCode", rowNumTwo,indZip);	
		ZipCode=indZip;
	}
	
	public static void selectCNState(String country) {
		...
		data.setCellData(sheetName, "Country", rowNumTwo, country);
		data.setCellData(sheetName, "State", rowNumTwo,State );		
		data.setCellData(sheetName, "ZipCode", rowNumTwo,chinaZip);	
		ZipCode=chinaZip;
	}

	
	public static void selectUSState(String country) {
		...
		data.setCellData(sheetName, "Country", rowNumTwo, country);
		data.setCellData(sheetName, "State", rowNumTwo, State);		
		data.setCellData(sheetName, "ZipCode", rowNumTwo,usZip);
	...
	public static void unitType() {
		...
		data.setCellData(sheetName, "Unit", rowNumTwo, Unit);
	}
	
	public static void spaceType() {
		...
		data.setCellData(sheetName, "SpaceType", rowNumTwo, SpaceType);
	}
	
	
	public static void ownerType() {
		...
		data.setCellData(sheetName, "OwnerType", rowNumTwo, OwnerType);
		
	}
	
	public static void setOwnerCountryAddressOwnerOrg(String country) {
		
		
		data.setCellData(sheetName, "OwnerCountry", rowNumTwo, country);
		
		data.setCellData(sheetName, "Address", rowNumTwo, "Sapphire club");
		
		data.setCellData(sheetName, "OwnerOrg", rowNumTwo, "T");
	}
	...
	public static String protfolioName() {
	    String generatedString = RandomStringUtils.randomNumeric(5);
	    String protfolioName = "Test Portfolio-"+generatedString;	
		System.out.println(protfolioName);
