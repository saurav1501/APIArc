...
public class AssetNotificationSubscriptionPostTest extends BaseClass {
	...
	public void AssetNotificationSubscriptionPost(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest(
				"AssetNotificationSubscription Post Test " + CommonMethod.getLabel(CommonMethod.responsetime),
				"AssetNotificationSubscriptionPostTest").assignCategory("AssetNotificationSubscriptionPostTest");
