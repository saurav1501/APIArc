...
public class AssetUpdateBuildingNoneAPITest extends BaseClass {
	...
	public void AssetUpdateforNewAssetPUTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		jsonAsMap.put("name", ProjectName + "-U");*/
		jsonAsMap.put("operating_hours", "30");
		jsonAsMap.put("year_constructed", "2018");
		jsonAsMap.put("exclude_spaces", "true");
		jsonAsMap.put("survey_score_occupant", "total_occupant");//choices are: total_occupant/regular_occupant/visitor_occupant
