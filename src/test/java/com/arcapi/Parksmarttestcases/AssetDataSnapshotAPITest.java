	...
	public void AssetDataSnapshotAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res= given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + 
						"/snapshot/?start_date=2017-01-01&end_date=2017-12-30&email="+data.getCellData(SheetName, "NormalUserName", rownumber) )
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetDataSnapshot API Test " + CommonMethod.getLabel(CommonMethod.responsetime),
						"AssetDataSnapshotAPITest")
				.assignCategory("AssetDataSnapshotAPITest");
