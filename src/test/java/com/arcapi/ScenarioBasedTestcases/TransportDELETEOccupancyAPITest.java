...
public class TransportDELETEOccupancyAPITest extends BaseClass{
	public class ExcludeSpacesTransportOccupantPOSTAPITest extends BaseClass {
		
		@Test(groups="VerifyDatacoverage")
		@Parameters({ "SheetName","ProjectTypeColumn","rownumber" })

		public void TransportDELETEOccupancyAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws JsonProcessingException {
