...
public class AssetTeamManagerAddPOSTAPITest extends BaseClass {

	@Test//(dependsOnMethods = { "com.arcapi.testcases.CreateAssetPOSTAPITest.CreateAssetPOSTAPI" })
    @Parameters({ "SheetName","ProjectTypeColumn","rownumber","Role","UserName" })
	public void AssetTeamMemberAddPOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber, String Role, String UserName) throws IOException {
		...
		CommonMethod.res = given().log().all()
				.parameters("user_email", data.getCellData(SheetName, UserName, rownumber), "Reltyp", Role, "Responsibility",
