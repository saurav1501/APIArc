...
public class CreateAssetBuildingOtherAPITest extends BaseClass {
	...
	public void CreateAssetPOSTAPI(String SheetName, String ProjectType, String ProjectTypeColumn, int rownumber,
		...
		String[] SpaceTypeOptions = { "Airport: Control Tower", "Airport: Distribution Center", "Airport: Hangar",
				"Airport: Office", "Airport: Other", "Airport: Public Order/Fire/Police", "Airport: Rental Car Center",
				"Airport: Terminal/Concourse", "Airport: Vehicle Service/Repair",
				"Core Learning Space: College/University", "Core Learning Space: K-12 Elementary/Middle School",
				"Core Learning Space: K-12 High School", "Core Learning Space: Other classroom education",
				"Core Learning Space: Preschool/Daycare", "Data Center", "Healthcare: Inpatient",
				"Industrial Manufacturing", "Laboratory", "Lodging: Dormitory", "Warehouse: Refrigerated",
				"Warehouse: Self Storage Units", "Other" };
		...
		String[] OwnerTypeOptions = { "Business Improvement District",
				"Community Development Corporation or Non-profit developer", "Corporate: Privately Held",
				"Corporate: Publicly Traded", "Educational: College, Private", "Educational: College, Public",
				"Educational: Community College, Private", "Educational: Community College, Public",
				"Educational: Early Childhood Education/Daycare", "Educational: K-12 School, Private",
				"Educational: K-12 School, Public", "Educational: University, Private",
				"Educational: University, public", "Government Use: Federal", "Government Use: Local, City",
				"Government Use: Local, Public Housing Authority", "Government Use: Other (utility, airport, etc.)",
				"Government Use: State", "Investor: Bank", "Investor: Endowment", "Investor: Equity Fund",
				"Investor: Individual/Family", "Investor: Insurance Company", "Investor: Investment Manager",
				"Investor: Pension Fund", "Investor: REIT, Non-traded", "Investor: REIT, Publicly traded",
				"Investor: ROEC", "Main Street Organization", "Non-Profit (that do not fit into other categories)",
				"Religious" };
		...
		data.setCellData(SheetName, "OwnerOrg", rownumber, "T");
		
		data.setCellData(SheetName, "Address", rownumber, "Sapphire club");
		...
		CommonMethod.res = given().log().all()
				.parameters("name", ProjectName, "rating_system", "other", "gross_area", "10000", "occupancy", "50",
						...
						"project_type", ProjectType, "unitType", Unit, "spaceType", SpaceType, "owner_email",
						"stg-01@gmail.com", "ownerType", OwnerType, "confidential", false, "sign_agreement", false,
						"zip_code", ZipCode, "organization", data.getCellData("OFAC", "OFACNAME", i), "manageEntityCountry", data.getCellData("OFAC", "CountryCode", i))
		...
		//data.setCellData("OFAC", "Result", i, "PASS");
