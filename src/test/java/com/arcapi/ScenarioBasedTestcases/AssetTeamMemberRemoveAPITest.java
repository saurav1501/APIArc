...
public class AssetTeamMemberRemoveAPITest extends BaseClass {
	...
	public void AssetTeamMemberRemoveAPI(String SheetName,String ProjectTypeColumn, int rownumber, String UserName) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetTeamMember Remove API Test" + CommonMethod.getLabel(CommonMethod.responsetime),
