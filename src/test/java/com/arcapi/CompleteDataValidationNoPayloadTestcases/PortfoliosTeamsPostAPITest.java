...
public class PortfoliosTeamsPostAPITest extends BaseClass {
	...
	public void PortfoliosTeamsPostAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {

		CommonMethod.ExtentReportConfig();

		// CommonMethod.GeneratingAuthCode();

		CommonMethod.test = CommonMethod.extent.startTest("PortfoliosTeams Post API Test  ", "Verifies Portflios")
