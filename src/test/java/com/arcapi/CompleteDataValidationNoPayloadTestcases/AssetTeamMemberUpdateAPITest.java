...
public class AssetTeamMemberUpdateAPITest extends BaseClass {
	...
	public void AssetTeamMemberUpdateAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetTeamMember Update API Test", "Verifies Team member updation")
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.put("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/teams/update/")
