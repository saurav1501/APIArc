...
public class AssetCertificationPOSTAPITest extends BaseClass {
	...
	public void AssetCertificationPOSTAPI(String SheetName, String ProjectTypeColumn, int rownumber)
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetCertificationPOST API Test", "AssetCertificationPOSTAPITest")
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.post("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/certifications/")
