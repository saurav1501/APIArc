...
public class AssetTeamPermissionPostAPITest extends BaseClass {
	...
	public void AssetTeamPermissionPostAPI(String SheetName, String ProjectTypeColumn, int rownumber)
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetTeamPermissionPost API Test ", "AssetTeamPermissionPostAPITest")
		...
		CommonMethod.res = given()
				...
				.header("content-type", "application/json").spec(reqSpec).when().post("/assets/LEED:"
						+ data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/permissions/requests/")
