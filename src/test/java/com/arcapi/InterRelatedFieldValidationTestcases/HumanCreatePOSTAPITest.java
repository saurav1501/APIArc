...
public class HumanCreatePOSTAPITest extends BaseClass {
	...
	public void HumanCreatePOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("HumanCreatePOST API Test ",
		...
		List<String> Actvalue = Arrays.asList("person", "ppm", "days", "dollar");
