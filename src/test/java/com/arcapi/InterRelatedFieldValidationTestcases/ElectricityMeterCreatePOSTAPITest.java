...
public class ElectricityMeterCreatePOSTAPITest extends BaseClass {
	...
	public void ElectricityMeterCreatePOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("ElectricityMeterCreatePOST API Test ",
		...
		List<String> Actvalue = Arrays.asList("kWh", "MWh", "MBtu", "kBtu", "GJ");
