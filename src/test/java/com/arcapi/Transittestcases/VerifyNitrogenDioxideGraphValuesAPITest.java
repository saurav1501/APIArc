...
public class VerifyNitrogenDioxideGraphValuesAPITest extends BaseClass {

	@Test
	@Parameters({ "SheetName","ProjectTypeColumn","rownumber" })
	public void VerifyNitrogenDioxideGraphValuesAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyNitrogenDioxideGraphValuesAPI",
       ...
       String NO_Meter_ID = data.getCellData("Graphs", "TransitHEMeterID", rownumber+2);
		...
		CommonMethod.res = given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/resampled/"+NO_Meter_ID+"/").then()
				.extract().response();
		...
		System.out.println(CommonMethod.res.asString());
		 ...
		 for(int j=0;j<12;j++) {
			    ...
			    //data.setCellData("Graphs", "NitrogenDioxide", j+2 , reading);
				String Act_Reading = data.getCellData("Graphs", "NitrogenDioxide", j+2);
