...
public class VerifyExcelTemplateConsumptionTransitAboveTest extends BaseClass {

	@Test
	@Parameters({ "SheetName", "ProjectTypeColumn", "rownumber" })
	public void VerifyExcelTemplateConsumptionAPI(String SheetName, String ProjectTypeColumn, int rownumber)
			throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyExcelTemplateConsumptionAPI Test", "Verifies consumption list")
