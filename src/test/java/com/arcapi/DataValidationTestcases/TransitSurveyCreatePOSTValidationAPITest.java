package com.arcapi.DataValidationTestcases;
...
public class TransitSurveyCreatePOSTValidationAPITest extends BaseClass {
	...
	public void TransitSurveyCreatePOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException, InterruptedException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("TransitSurveyCreatePOSTBadNameAPITest",
		...
		CommonMethod.res = given().log().all()
				...
				.body(jsonAsMap).when()
				.post("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/survey/transit/?key="
						+ data.getCellData(SheetName, "BuildingKeyID", rownumber)).then()
				.extract().response();
