...
public class AssetUpdateforNewAssetPUTValidationAPITest extends BaseClass {
	...
	public void AssetUpdateforNewAssetPUTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetUpdateforNewAssetPUTBadCountryAPITest",
		...
		jsonAsMap.put("lobby_survey_status",str);
