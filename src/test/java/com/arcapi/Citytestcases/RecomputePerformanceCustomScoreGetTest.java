...
public class RecomputePerformanceCustomScoreGetTest extends BaseClass {
	...
	public void RecomputePerformanceScoreGet(String SheetName,String CustomSheetName, int rownumber, String paramvalue) throws IOException {
		...
		CommonMethod.fetchedID = Double.toString(valueRounded);
		
		CommonMethod.fetchedID = CommonMethod.fetchedID.replaceAll("[.][0-9]+$", "");
