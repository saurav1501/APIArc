...
public class CityCommConsumptionCreateAPITest extends BaseClass {
	...
	public void ConsumptionCreatePOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		int RowNum = data.getRowCountbyColNum("DataInput", 13);
		...
		jsonAsMap1.put("end_date", "2018-01-31");
		...
		CommonMethod.res = given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.post("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/meters/ID:"
						+ data.getCellData("DataInput", "CityMeterID", i) + "/consumption/")
