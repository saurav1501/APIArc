...
public class MeterCreateAPICustomCityCommTest extends BaseClass {

	@Test// (dependsOnMethods={"com.arcapi.testcases.CreateAssetPOSTAPITest.CreateAssetPOSTAPI"})
	@Parameters({ "SheetName","CustomSheetName","Unit","Type", "rownumber" })
	public void MeterCreatePOSTAPI(String SheetName,String CustomSheetName, String Unit, String Type, int rownumber) throws IOException {
		...
		Customdata.setCellData(CustomSheetName, "CityMeterID", i, CommonMethod.fetchedID);
