...
public class AssetRequiredFieldsAPITest extends BaseClass {
	...
	public void AssetRequiredFieldsAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetRequiredFields API Test " + CommonMethod.getLabel(CommonMethod.responsetime),
						"AssetRequiredFieldsAPITest")
				.assignCategory("AssetRequiredFieldsAPITest");
