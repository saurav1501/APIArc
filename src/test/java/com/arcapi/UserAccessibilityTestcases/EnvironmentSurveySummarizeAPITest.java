...
public class EnvironmentSurveySummarizeAPITest extends BaseClass {
	...
	public void EnvironmentSurveySummarizeAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Environment Survey summarize API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
						"Verifies Environment survey summary")
		...
		CommonMethod.fetchingJSONResponse(
				"/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/survey/environment/summarize/");
