...
public class WasteDetailAPITest extends BaseClass {
	...
	public void WasteDetailAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/waste/ID:"
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Waste Detail API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
		...
		CommonMethod.fetchingJSONResponse("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/waste/ID:"
				+data.getCellData(SheetName, "WasteID", rownumber) + "/");
