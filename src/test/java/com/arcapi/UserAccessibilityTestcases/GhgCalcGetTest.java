...
public class GhgCalcGetTest extends BaseClass {
	...
	public void GhgCalcGet(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:"+data.getCellData(SheetName, ProjectTypeColumn, rownumber)+"/ghgcalc/?resample=2015-01-05/P1D,2015-01-06/P1D,2015-01-07/P1D,2015-01-08/P1D")
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("GhgCalc Get API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
		...
		CommonMethod.fetchingJSONResponse("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber)
				+ "/ghgcalc/?resample=2017-01-05/P1D,2017-01-06/P1D,2017-01-07/P1D,2017-01-08/P1D");
