...
public class PaymentHistoryAPITest extends BaseClass {
	...
	public void PaymentHistoryAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/payments/history/").then()
				.extract().response();
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Payment History API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
						"Verifies Payment History details for asset")
		...
		CommonMethod.fetchingJSONResponse(
				"/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/payments/history/");
