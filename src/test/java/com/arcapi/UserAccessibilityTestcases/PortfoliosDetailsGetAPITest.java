...
public class PortfoliosDetailsGetAPITest extends BaseClass {
	...
	public void PortfoliosDetailsGetAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod
				.fetchingJSONResponse("/portfolios/ID:" + data.getCellData(SheetName, "PortfolioID", rownumber) + "/");
