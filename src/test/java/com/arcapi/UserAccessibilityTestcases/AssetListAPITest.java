...
public class AssetListAPITest extends BaseClass {
	...
	public void AssetListAPI(String SheetName, int rownumber) {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Asset list API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
		...
		CommonMethod.fetchingJSONResponse("/assets/");
