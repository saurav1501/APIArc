...
public class AssetUpdateDeactivatedPUTAPITest extends BaseClass {
	...
	public void AssetUpdateforNewAssetPUTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.GeneratingAuthCodesAdminUser();
		...
		jsonAsMap.put("zip_code", "200370");
		jsonAsMap.put("lobby_survey_status", "True");
		jsonAsMap.put("building_status", "deactivated");
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Asset Update Test" + CommonMethod.getLabel(CommonMethod.responsetime),
