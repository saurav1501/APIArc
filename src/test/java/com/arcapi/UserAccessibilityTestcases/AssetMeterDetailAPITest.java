...
public class AssetMeterDetailAPITest extends BaseClass {
	...
	public void AssetMeterDetailAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Asset Meter Detail API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
						"Verifies Meter detail of particular asset")
		...
		CommonMethod.fetchingJSONResponse("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber)
				+ "/meters/ID:" + data.getCellData(SheetName, "MeterID", rownumber) + "/");
