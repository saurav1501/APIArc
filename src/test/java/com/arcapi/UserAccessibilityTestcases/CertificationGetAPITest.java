...
public class CertificationGetAPITest extends BaseClass {
	...
	public void CertificationGetAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Certification Get API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
						"Verifies Certification API")
		...
		CommonMethod.fetchingJSONResponse(
				"/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/certifications/");
