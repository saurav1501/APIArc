...
public class TemperatureDataZipCodeGetTest extends BaseClass {
	...
	public void TemperatureDataZipCodeGet(String SheetName, int rownumber) throws IOException {
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/ZIP:" + CommonMethod.ZipCode + "/temperature/").then().extract().response();
		...
		CommonMethod.fetchingJSONResponse("/assets/ZIP:" + CommonMethod.ZipCode + "/temperature/");
