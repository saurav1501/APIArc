...
public class CreditUpdateTeamPOSTAPITest extends BaseClass {
	...
	public void CreditUpdateTeamPOSTAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().log().all()
				.parameters("emails", data.getCellData(SheetName, "CreditTeamMember", rownumber))
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("CreditUpdateTeamTest  " + CommonMethod.getLabel(CommonMethod.responsetime),
						"Verifies Credit team")
