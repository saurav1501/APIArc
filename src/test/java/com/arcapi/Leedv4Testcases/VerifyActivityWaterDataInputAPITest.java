...
public class VerifyActivityWaterDataInputAPITest extends BaseClass {

	@Test 
	@Parameters({ "LOSheetName", "LOProjectTypeColumn", "rownumber" })
	public void VerifyActivityWaterDataInputAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyActivityWaterDataInputAPI", "Verifies Update asset").assignCategory("CheckAsset");
			...
			data.setCellData("Report", "TestCaseName", reportrownum, TestName);
				...
				CommonMethod.res = given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
						...
						.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber)
						 + "/activity/?order=desc&type=pf902")
				...
				String verb3 = "created a new meter <a class=\"handle\">UploadWaterMeterTest</a>";
