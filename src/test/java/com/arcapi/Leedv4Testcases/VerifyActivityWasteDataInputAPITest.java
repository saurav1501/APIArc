...
public class VerifyActivityWasteDataInputAPITest extends BaseClass {
	...
	public void VerifyActivityWasteDataInputAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyActivityWasteDataInputAPI", "Verifies Update asset").assignCategory("CheckAsset");
