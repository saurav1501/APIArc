...
public class LOProjectRegistrationEBTest extends BaseClass {
	...
	public void LOProjectRegistration(String SheetName,int rownumber, String Country) throws IOException {
		...
		String ProjectName = "Test LeedOnline O+M:EB Project " + Country;
		...
		jsonAsMap.put("ratingSystem", "v4_1.oEb");
