...
public class CreditAddTeamPOSTAPITest extends BaseClass {
	...
	public void CreditAddTeamPOSTAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {

		CommonMethod.ExtentReportConfig();

		// CommonMethod.GeneratingAuthCode();

		CommonMethod.test = CommonMethod.extent.startTest("CreditAddTeam POST API Test  ", "CreditAddTeamPOSTAPITest")
		...
		for (String str : value) {
			...
			CommonMethod.res = given().parameters("emails", str)
					...
					.post("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/actions/ID:"
							...
							+ data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/teams/")
