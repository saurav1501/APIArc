...
public class NotificationCreatePOSTAPITest extends BaseClass {
	...
	public void NotificationCreatePOSTAPI(String SheetName, String ProjectTypeColumn, int rownumber)
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Notification Create Post API Test  ", "Verifies Notification creation")
		...
		for (String str : value) {
			...
			CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
					...
					.body(jsonAsMap).when().post("/assets/LEED:"
							+ data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/notifications/")
