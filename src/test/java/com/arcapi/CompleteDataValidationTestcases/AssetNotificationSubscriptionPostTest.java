...
public class AssetNotificationSubscriptionPostTest extends BaseClass {
	...
	public void AssetNotificationSubscriptionPost(String SheetName, String ProjectTypeColumn, int rownumber)
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("AssetNotificationSubscription Post Test ", "AssetNotificationSubscriptionPostTest")
				.assignCategory("AssetNotificationSubscriptionPostTest");
		...
		for (String str : value) {
			...
			jsonAsMap.put("daily_score_notification", str);
			...
			CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
					...
					.body(jsonAsMap).when().post("/assets/LEED:"
							+ data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/subscriptions/")
