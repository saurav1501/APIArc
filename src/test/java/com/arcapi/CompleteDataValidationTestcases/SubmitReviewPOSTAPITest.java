...
public class SubmitReviewPOSTAPITest extends BaseClass {
	...
	public void SubmitReviewPOSTAPI(String SheetName, String ProjectTypeColumn, int rownumber, String ProjectType,String SoReferenceSR)
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("Submit Review POST API Test  ",
		...
		jsonAsMap.put("first_name", str);
		jsonAsMap.put("last_name", str);
		jsonAsMap.put("email", str);
		jsonAsMap.put("street", str);
		jsonAsMap.put("city", str);
		jsonAsMap.put("state", str);
		jsonAsMap.put("country", str);
		jsonAsMap.put("zip_code", str);
		jsonAsMap.put("company_code", str);
		jsonAsMap.put("base_score", str);
		jsonAsMap.put("energy_score", str);
		jsonAsMap.put("water_score", str);
		jsonAsMap.put("waste_score", str);
		jsonAsMap.put("human_score", str);
		jsonAsMap.put("transport_score", str);
		jsonAsMap.put("certification_payterm", str);
		jsonAsMap.put("annual_payterm", str);
		// jsonAsMap.put("material_price_grp", "L1");
		jsonAsMap.put("review_type", str);
		jsonAsMap.put("certification_level", str);
		jsonAsMap.put("certification_type", str);
		jsonAsMap.put("review_start_date", str);
		jsonAsMap.put("review_expiry_date", str);
		jsonAsMap.put("score_submitted", str);
		jsonAsMap.put("target_score", str);
		jsonAsMap.put("target_level",str);
		jsonAsMap.put("soreference", str);
		jsonAsMap.put("material_code", str);
		jsonAsMap.put("unit_price", str);
		jsonAsMap.put("actual_price", str);
		jsonAsMap.put("annual_price", str);
		jsonAsMap.put("quantity", str);
		jsonAsMap.put("material_desc", str);
		jsonAsMap.put("creditId", str);
		jsonAsMap.put("paymetric_r", str);
		jsonAsMap.put("paymetric_s", str);
