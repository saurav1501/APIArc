...
public class PortfoliosPostAPITest extends BaseClass {
	...
	public void PortfoliosPostAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {

		CommonMethod.ExtentReportConfig();

		// CommonMethod.GeneratingAuthCode();

		CommonMethod.test = CommonMethod.extent.startTest("Portfolios Post API Test  ", "Verifies Portflios")
		...
		for (String str : value) {
			...
			// jsonAsMap.put("partner_userid", "4");
			jsonAsMap.put("source", str);
			jsonAsMap.put("description", str);
			jsonAsMap.put("address", str);
			jsonAsMap.put("organization", str);
			jsonAsMap.put("organization_contact", str);
			jsonAsMap.put("organization_country", str);
			jsonAsMap.put("organization_email", str);
