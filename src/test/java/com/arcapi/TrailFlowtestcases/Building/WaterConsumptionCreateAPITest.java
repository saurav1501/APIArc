...
public class WaterConsumptionCreateAPITest extends BaseClass {
	...
	public void WaterConsumptionCreateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("WaterConsumptionCreate API Test" + CommonMethod.getLabel(CommonMethod.responsetime),
