...
public class OtherFuelConsumptionDeleteAPITest extends BaseClass {
	...
	public void OtherFuelConsumptionDeleteAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("OtherFuelConsumption Delete API" + CommonMethod.getLabel(CommonMethod.responsetime),
