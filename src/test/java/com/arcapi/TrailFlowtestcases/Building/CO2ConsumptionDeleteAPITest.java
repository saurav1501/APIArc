...
public class CO2ConsumptionDeleteAPITest extends BaseClass {
	...
	public void CO2ConsumptionDeleteAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest(" CO2 Consumption Delete API Test" + CommonMethod.getLabel(CommonMethod.responsetime),
