...
public class VOCMeterDeleteAPITest extends BaseClass {
	...
	public void VOCMeterDeleteAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.delete("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/meters/ID:"
						+ data.getCellData("DataInput", "VOCMeterID", rownumber) + "/")
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VOC Meter Delete API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
