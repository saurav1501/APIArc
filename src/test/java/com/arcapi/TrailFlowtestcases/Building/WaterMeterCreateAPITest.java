...
public class WaterMeterCreateAPITest extends BaseClass {
	...
	public void WaterMeterCreateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("WaterMeter Create API" + CommonMethod.getLabel(CommonMethod.responsetime),
