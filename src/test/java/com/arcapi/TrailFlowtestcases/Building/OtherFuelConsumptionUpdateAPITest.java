...
public class OtherFuelConsumptionUpdateAPITest extends BaseClass {
	...
	public void OtherFuelConsumptionUpdateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("OtherFuelConsumption Update API" + CommonMethod.getLabel(CommonMethod.responsetime),
