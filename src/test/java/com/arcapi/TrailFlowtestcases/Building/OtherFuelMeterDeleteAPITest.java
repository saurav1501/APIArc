...
public class OtherFuelMeterDeleteAPITest extends BaseClass {
	...
	public void OtherFuelMeterDeleteAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("OtherFuelMeter Delete API" + CommonMethod.getLabel(CommonMethod.responsetime),
