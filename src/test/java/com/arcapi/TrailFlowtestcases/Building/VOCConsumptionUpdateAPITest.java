...
public class VOCConsumptionUpdateAPITest extends BaseClass {
	...
	public void VOCConsumptionUpdateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VOC Consumption Update API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
