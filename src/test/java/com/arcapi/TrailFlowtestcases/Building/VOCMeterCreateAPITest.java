...
public class VOCMeterCreateAPITest extends BaseClass {
	...
	public void VOCMeterCreateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		jsonAsMap.put("name", "Total Volitile Organic Compounds");
		jsonAsMap.put("native_unit", "ug/m3");
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VOC Meter Create API" + CommonMethod.getLabel(CommonMethod.responsetime),
