...
public class VerifyAssetDetailAPITest extends BaseClass {
	...
	public void VerifyAssetDetailAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyAssetDetailAPI Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
		...
		CommonMethod.res.then().assertThat().body("spaceType", equalTo(data.getCellData(SheetName, "SpaceType", rownumber).toString()));
		...
		Assert.assertEquals(occupancy, "7");
