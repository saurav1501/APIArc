...
public class MeasuresVersionPostAPITest extends BaseClass {
	...
	public void MeasuresVersionPostAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		jsonAsMap.put("status", "Ready for Review");
		jsonAsMap.put("assigned_to", data.getCellData(SheetName, "NormalUserName", rownumber));
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("MeasuresVersionPost API Test" + CommonMethod.getLabel(CommonMethod.responsetime),
						"MeasuresVersionPostAPITest")
