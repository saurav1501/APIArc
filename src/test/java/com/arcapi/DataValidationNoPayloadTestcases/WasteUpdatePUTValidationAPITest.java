...
public class WasteUpdatePUTValidationAPITest extends BaseClass {
	...
	public void WasteUpdatePUTAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("WasteUpdatePUTBadEDateAPITest", "Verifies Waste meter update detail")
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				.header("content-type", ContentType.JSON).header("Authorization", header).spec(reqSpec).when()
