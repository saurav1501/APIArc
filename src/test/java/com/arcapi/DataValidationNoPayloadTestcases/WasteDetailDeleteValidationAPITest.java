...
public class WasteDetailDeleteValidationAPITest extends BaseClass {
	...
	public void WasteDetailDeleteAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("WasteDetailDeleteBadUrlAPITest", "Verifies Waste delete Meter")
		...
		CommonMethod.res = given().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.delete("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber) + "/waste/ID:/")
