...
public class AmltojsonTest extends BaseClass{ 

     @AfterSuite
     public void test() throws Exception {
		 
		 final DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd:hh-mm");
       CommonMethod.fetchedID = "/var/lib/jenkins/workspace/ARC-API/AutomationTesting/TestArcAPI/JsonReport/APIReport"+formatter.format(new Date())+".json";
       System.out.println(CommonMethod.fetchedID);
      // CommonMethod.filewriteID(CommonMethod.JsonfileUrl);
        
        try {           
           File file = new File ("/var/lib/jenkins/workspace/ARC-API/AutomationTesting/TestArcAPI//target/surefire-reports/APITestCasesSuite/CompleteFlowTest-Building.xml");  
           ...
           FileWriter fileWriter =
               new FileWriter(CommonMethod.fetchedID);
           ...
           // Always close files.
            ...
            for(int i= 0 ;i <= jsonObj.toString().split(",").length-1; i ++) {
