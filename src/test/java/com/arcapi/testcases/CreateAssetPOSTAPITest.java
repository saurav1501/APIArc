	...
	public void CreateAssetPOSTAPI(String SheetName, String ProjectType, String ProjectTypeColumn, int rownumber)
		...
		CommonMethod.res = given().log().all()
				...
				.parameters("name", "Test Project",
						...
						"rating_system", "other", "gross_area", "10000", "occupancy", "500", "street", "Test Address",
						"city", "Beijing", "country", Country, "state", StateCode, "project_type", ProjectType,
						"unitType", "IP", "spaceType", "Circulation space", "owner_email", "stg-01@gmail.com",
						"ownerType", "Educational: College, Private", "confidential", false, "sign_agreement", false,
						"zip_code", "065001", "organization", "T", "manageEntityCountry", Country)
