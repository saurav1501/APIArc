...
public class WasteDivertedDataGetTest extends BaseClass {
	...
	public void WasteDivertedDataGet(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.res = given().log().all().header("Ocp-Apim-Subscription-Key", CommonMethod.SubscriptionKey)
				...
				.get("/assets/LEED:" + data.getCellData(SheetName, ProjectTypeColumn, rownumber)
						+ "/waste/generated/?units=lbs&resample=2016-01-18/P1D,2016-01-19/P1D")
