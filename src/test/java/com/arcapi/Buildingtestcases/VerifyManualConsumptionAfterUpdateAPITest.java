...
public class VerifyManualConsumptionAfterUpdateAPITest extends BaseClass {
	...
	public void VerifyManualConsumptionAfterUpdateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VerifyManualConsumptionAfterUpdateAPI",
