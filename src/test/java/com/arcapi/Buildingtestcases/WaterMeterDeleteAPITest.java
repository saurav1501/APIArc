...
public class WaterMeterDeleteAPITest extends BaseClass {
	...
	public void WaterMeterDeleteAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("WaterMeter Delete API" + CommonMethod.getLabel(CommonMethod.responsetime),
