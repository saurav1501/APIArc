...
public class CO2ConsumptionCreateAPITest extends BaseClass {
	...
	public void CO2ConsumptionCreateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("CO2 Consumption create Post API Test  " + CommonMethod.getLabel(CommonMethod.responsetime),
