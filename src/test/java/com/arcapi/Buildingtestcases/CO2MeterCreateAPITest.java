...
public class CO2MeterCreateAPITest extends BaseClass {
	...
	public void CO2MeterCreateAPI(String SheetName,String ProjectTypeColumn, int rownumber) throws IOException {
		...
		jsonAsMap.put("name", "Carbon Dioxide");
		jsonAsMap.put("native_unit", "ppm");
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("CO2 Meter Create API" + CommonMethod.getLabel(CommonMethod.responsetime),
