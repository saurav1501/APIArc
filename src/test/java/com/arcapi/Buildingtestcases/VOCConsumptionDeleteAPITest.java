...
public class VOCConsumptionDeleteAPITest extends BaseClass {
	...
	public void VOCConsumptionDeleteAPI(String SheetName, String ProjectTypeColumn, int rownumber) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent
				.startTest("VOC Consumption Delete API Test" + CommonMethod.getLabel(CommonMethod.responsetime),
